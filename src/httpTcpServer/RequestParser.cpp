...
namespace {
	void parseRequestQueries(http::Request& request) {
	...
	void parsePath(http::Request& request, const ServerConfig& serverInfo) {
	...
	bool parseRequestLine(http::Request& req, const ServerConfig& serverInfo, const std::string& readBuffer,
	                      size_t lineEnd) {
	...
	void parseRequestHeaders(http::Request& req, const std::string& readBuffer, size_t headerEnd) {
		const char* data = readBuffer.c_str();
		size_t pos = 0;
		while (pos < headerEnd) {
	...
	void discardingBody(Client& client) {
	...
	bool parseContentLengthBody(Client& client, const ServerConfig& configs) {
	...
	bool parseChunkBody(Client& client, const ServerConfig& configs) {
		std::string& buffer = client.getReadBuffer();
	...
	bool parseRequestBody(Client& client, const ServerConfig& configs) {
...
bool http::RequestParser::parseRequestBuffer(Client& client, const ServerConfig& serverInfo) {
